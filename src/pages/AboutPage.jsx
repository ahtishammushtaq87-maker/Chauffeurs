    ...
    <>
      ...
      <section id="quote" className="relative flex items-center overflow-hidden border-b border-ink-border bg-ink">
        <div className="absolute inset-0">
          <PlaceholderImage src={aboutImages.heroImg} alt="Swift Chauffeurs luxury vehicle fleet in Nashville" />
        </div>
        ...
        <div className="relative z-10 flex w-full flex-col items-start gap-6 px-5 py-10 sm:gap-10 sm:px-10 sm:py-14 md:px-16 lg:flex-row lg:items-center lg:justify-between lg:gap-8 lg:px-20">
          <div className="flex-shrink-0 rounded-lg bg-black/50 p-5 sm:p-6 lg:max-w-lg">
            ...
            <h1 className="font-serif text-[2rem] leading-[1.15] font-medium text-ink-fg sm:text-5xl md:text-[52px]">
              About Swift Chauffeurs
            </h1>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-ink-fg-muted">
              Swift Chauffeurs provides private, professionally coordinated transportation in Nashville, TN and across
              Tennessee. Our focus is simple: clear communication, the right vehicle for each journey, professional
              chauffeur service, and a comfortable experience from pickup to destination.
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3 sm:gap-4">
              <a href={PHONE} className="btn btn-gold">
                <PhoneIcon width={15} height={15} /> Call Swift Chauffeurs
              </a>
            </div>
          </div>
          ...
          <div className="w-full max-w-md lg:flex-shrink-0">
            <QuoteForm
              heading={<>Request Your Chauffeur <span className="text-gold">Quote</span></>}
              submitLabel="Request Your Chauffeur Quote"
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-(--breakpoint-xl) grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <h2 className="font-serif text-3xl leading-tight font-medium text-text md:text-4xl">
              Our Story: Professional Chauffeur Service Since 2017
            </h2>
            <p className="mt-5 text-[15px] leading-relaxed text-text-muted">
              Swift Chauffeurs was founded in 2017 to provide a more dependable, professional, and personalized
              approach to private transportation in Tennessee. From the beginning, our goal has been to make every
              reservation feel carefully planned—from the first conversation and vehicle selection to pickup, travel,
              and final arrival.
            </p>
            <p className="mt-4 text-[15px] leading-relaxed text-text-muted">
              Today, we coordinate chauffeur service for airport travel, corporate transportation, weddings, special
              occasions, private journeys, and groups throughout Nashville and beyond. As our fleet and service
              network have grown, our priorities have remained the same: responsive communication, professional
              presentation, dependable coordination, and travel tailored to each customer.
            </p>
          ...
          <div className="relative order-1 aspect-[4/3] overflow-hidden rounded-xl border border-border lg:order-2">
            <PlaceholderImage src={aboutImages.storyImg} alt="Swift Chauffeurs vehicle prepared for service in Nashville" />
          </div>
        </div>
      </section>
      ...
      <section className="border-y border-border px-6 py-20 md:px-16 lg:px-24">
        <div className="mx-auto grid max-w-(--breakpoint-xl) grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="relative aspect-[4/3] overflow-hidden rounded-xl border border-border">
            <PlaceholderImage src={aboutImages.whyChooseImg} alt="Professional Swift Chauffeurs chauffeur in Nashville" />
          </div>
          <div>
      ...
      <section className="px-6 py-20 md:px-16 lg:px-24">
        <div className="mx-auto grid max-w-(--breakpoint-xl) grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div>
            ...
            <p className="mt-5 text-[15px] leading-relaxed text-text-muted">
              Customer safety is central to every Swift Chauffeurs reservation. Vehicles are professionally maintained
              and prepared for service, and chauffeurs are expected to follow applicable traffic laws and safe-driving
              practices. Our team also coordinates trip details in advance and remains available to support the journey
              from pickup through final arrival.
            </p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-border">
              <PlaceholderImage src={aboutImages.safetyImg1} alt="Swift Chauffeurs vehicle prepared for service" />
            </div>
            <div className="relative mt-8 aspect-[3/4] overflow-hidden rounded-xl border border-border">
              <PlaceholderImage src={aboutImages.safetyImg2} alt="Professional Swift Chauffeurs chauffeur" />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* How to Reserve Your Chauffeur Service */}
      <section className="border-y border-border px-6 py-20 md:px-16 lg:px-24">
      ...
      {/* Explore Our Chauffeur Services slider */}
      ...
      {/* About Swift Chauffeurs FAQs */}
      <section className="border-t border-border px-6 py-20 md:px-16 lg:px-24">
        <div className="mx-auto max-w-3xl">
          <div className="mb-10 text-center">
            <span className="eyebrow">FAQ</span>
            <h2 className="font-serif text-3xl font-medium text-text md:text-4xl">About Swift Chauffeurs FAQs</h2>
          </div>
          <FaqAccordion items={aboutFaqs} />
        </div>
      </section>

      {/* Contact Swift Chauffeurs */}
      <section className="px-6 py-20 md:px-16 lg:px-24">
        <div className="mx-auto max-w-(--breakpoint-xl) rounded-2xl border border-border bg-panel p-10 md:p-14">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
            <div>
              ...
              <p className="mt-4 text-[15px] leading-relaxed text-text-muted">
                Have questions about a vehicle, service, or upcoming reservation? Share your travel details and our
                team will help you choose the right option for your schedule, group size, destination, and occasion.
                Contact Swift Chauffeurs for clear information and personalized reservation support.
              </p>
            </div>
            <div className="flex flex-col gap-5 lg:border-l lg:border-border lg:pl-10">
              <a href={toTelHref(settings.phone_1)} className="flex items-center gap-3 text-text hover:text-gold">
