        ...
        <div className="mx-auto w-full max-w-(--breakpoint-xl)">
          <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-3 sm:gap-3 lg:grid-cols-5">
            {areas.map((area) => (
              <div
                key={area}
                className="flex items-center gap-2.5 rounded-lg border border-white/15 bg-black/40 px-3 py-3 text-sm text-white/90 backdrop-blur-sm transition-colors hover:border-gold-dim hover:text-gold sm:px-4 sm:py-3.5"
              >
